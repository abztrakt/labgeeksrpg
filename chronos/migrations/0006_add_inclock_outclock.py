...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('chronos_shift', 'in_clock_id')

        # Deleting field 'Shift.out_clock'
        db.delete_column('chronos_shift', 'out_clock_id')
    ...
    models = {
        ...
        'chronos.shift': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'in_clock': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'in_punchclock'", 'to': "orm['chronos.Punchclock']"}),
            'intime': ('django.db.models.fields.DateTimeField', [], {}),
            'out_clock': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'out_punchclock'", 'blank': 'True', 'null': 'True', 'to': "orm['chronos.Punchclock']"}),
