...
urlpatterns = patterns('labgeeksrpg.chronos.views',
    ...
    (r'^time/fail/', 'fail'),
    url(r'^(?P<user>\w+)/(?P<year>\w+)/(?P<month>\w+)/$','personal_report', name="Personal-Report_Monthly"),
    url(r'^(?P<user>\w+)/(?P<year>\w+)/(?P<month>\w+)/payperiod/(?P<payperiod>\w+)','personal_report_specific', name="Personal-Report-Payperiod"),
    url(r'^(?P<user>\w+)/(?P<year>\w+)/(?P<month>\w+)/week/(?P<week>\w+)','personal_report_specific', name="Personal-Report-Weekly"),
    url(r'^(?P<user>\w+)/(?P<year>\w+)/(?P<month>\w+)/(?P<day>\w+)', 'personal_report_specific',name="Personal-Report-Specific"),
