...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.staff_photo'
        db.add_column('people_userprofile', 'staff_photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.staff_photo'
        db.delete_column('people_userprofile', 'staff_photo')
