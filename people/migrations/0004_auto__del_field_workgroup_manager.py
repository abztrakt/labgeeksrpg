...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WorkGroup.manager'
        db.delete_column('people_workgroup', 'manager_id')


    def backwards(self, orm):
        
        # Adding field 'WorkGroup.manager'
        db.add_column('people_workgroup', 'manager', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['auth.User']), keep_default=False)
