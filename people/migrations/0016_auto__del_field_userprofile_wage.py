...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.wage'
        db.delete_column('people_userprofile', 'wage_id')

        # Adding M2M table for field wage on 'UserProfile'
        db.create_table('people_userprofile_wage', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['people.userprofile'], null=False)),
            ('wagehistory', models.ForeignKey(orm['people.wagehistory'], null=False))
        ))
        db.create_unique('people_userprofile_wage', ['userprofile_id', 'wagehistory_id'])


    def backwards(self, orm):
        
        # Adding field 'UserProfile.wage'
        db.add_column('people_userprofile', 'wage', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.WageHistory'], null=True, blank=True), keep_default=False)

        # Removing M2M table for field wage on 'UserProfile'
        db.delete_table('people_userprofile_wage')
