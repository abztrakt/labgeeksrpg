...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('people_timeperiod', (
            ...
            ('end_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 2, 17))),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 2, 17))),
