...
class ReviewTestCase(TestCase):
    ...
    def testManagerPermissions(self):
        ...
        resp1 = c.get('/people/Manager/review/#view_reviews')
        self.assertEqual(resp1.status_code, 200)
        resp2 = c.get('/people/Dawg/review/#view_reviews')
        self.assertEqual(resp2.status_code, 200)
        resp3 = c.get('/people/BigBoss/review/#view_reviews')
        self.assertEqual(resp3.status_code, 200)
        resp4 = c.get('/people/Manager/review/info/?id=2')
        self.assertEqual(resp4.status_code, 200)
        resp5 = c.get('/people/Dawg/review/info/?id=1')
        self.assertEqual(resp5.status_code, 200)
        # possibly unwanted behavior:  as is, add_review gives power to review anyone, including your boss.  And jsons?
        c.logout()
    ...
    def testBigBossPermissions(self):
        ...
        resp1 = c.get('/people/Manager/review/#view_reviews')
        self.assertEqual(resp1.status_code, 200)
        resp2 = c.get('/people/BigBoss/review/#view_reviews')
        self.assertEqual(resp2.status_code, 200)
        resp3 = c.get('/people/Dawg/review/info/?id=1')
        self.assertEqual(resp3.status_code, 200)
        resp4 = c.get('/people/BigBoss/review/info/?id=3')
        self.assertEqual(resp4.status_code, 200)
        c.logout()
