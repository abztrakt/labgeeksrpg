...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Player.office'
        db.add_column('player_player', 'office', orm['player.player:office'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Player.office'
        db.delete_column('player_player', 'office')
